...
import type { ExamConfig, ExamDetail, ExamQuestion, RoomOut } from '@/features/exam'
...
function ExamPage() {
  ...
  const { mutate: createRoom, isPending: isCreatingRoom } = useCreateRoom(savedExam?.id ?? 0)

    ...
    >
      ...
      <div className="flex items-center gap-3 px-5 py-5 border-b border-white/10">
        ...
        <div>
          ...
          <div className="text-[10.5px] text-blue-200/70">
            Trợ lý Áo Giảng dạy
          </div>
        </div>
      </div>
      ...
      <nav className="flex-1 overflow-y-auto px-3 py-4 space-y-1">
        <p className="px-3 mb-2 text-[10px] font-bold uppercase tracking-widest text-blue-300/50">
          Tổng quan
        </p>
        ...
        <p className="px-3 mt-4 mb-2 text-[10px] font-bold uppercase tracking-widest text-blue-300/50">
          Chức năng chính
        </p>
      ...
      <div className="border-t border-white/10 p-3" ref={menuRef}>
        ...
        >
          ...
          <div className="min-w-0 flex-1">
            <strong className="block truncate text-[12.5px] text-white">
              {user?.name ?? "..."}
            </strong>

...
MAIN_PROMPT = ChatPromptTemplate.from_template(
    ...
    f"- Nếu context không đủ hoặc câu hỏi không liên quan đến Tin học THPT, trả lời bằng kiến thức bạn có theo ngôn ngữ câu hỏi, và không thêm gì khác.\n\n"
